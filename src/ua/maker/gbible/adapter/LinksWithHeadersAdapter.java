...
public class LinksWithHeadersAdapter extends ArrayAdapter<ItemReadDay> {
	...
	public LinksWithHeadersAdapter(Context context, List<ItemReadDay> data, DataBase db) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.llOldTestament.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				Log.d(TAG, "Click OLD TEST: " + position);
			}
		});
		
		holder.llNewTestament.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				Log.d(TAG, "Click NEW TEST: " + position);
			}
		});
