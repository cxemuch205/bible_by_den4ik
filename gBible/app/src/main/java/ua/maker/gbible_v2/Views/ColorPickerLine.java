 ...
 */
public class ColorPickerLine extends View{
    ...
    public ColorPickerLine(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColorPickerLine(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mHuePanelWidthPx = Tools.dpToPx(getContext(), HUE_PANEL_WDITH_DP);
        mAlphaPanelHeightPx = Tools.dpToPx(getContext(), ALPHA_PANEL_HEIGH_DP);
        mPanelSpacingPx = Tools.dpToPx(getContext(), PANEL_SPACING_DP);
        mCircleTrackerRadiusPx = Tools.dpToPx(getContext(), CIRCLE_TRACKER_RADIUS_DP);
        mSliderTrackerSizePx = Tools.dpToPx(getContext(), SLIDER_TRACKER_SIZE_DP);
        mSliderTrackerOffsetPx = Tools.dpToPx(getContext(), SLIDER_TRACKER_OFFSET_DP);
    ...
    private void initPaintTools(){
        ...
        mSatValTrackerPaint.setStrokeWidth(Tools.dpToPx(getContext(), 2));
        mSatValTrackerPaint.setAntiAlias(true);

        mHueAlphaTrackerPaint.setColor(mSliderTrackerColor);
        mHueAlphaTrackerPaint.setStyle(Style.STROKE);
        mHueAlphaTrackerPaint.setStrokeWidth(Tools.dpToPx(getContext(), 2));
        mHueAlphaTrackerPaint.setAntiAlias(true);

        mAlphaTextPaint.setColor(0xff1c1c1c);
        mAlphaTextPaint.setTextSize(Tools.dpToPx(getContext(), 14));
    ...
    private void drawSatValPanel(Canvas canvas){
        ...
        canvas.drawCircle(p.x, p.y,
                mCircleTrackerRadiusPx - Tools.dpToPx(getContext(), 1),
                mSatValTrackerPaint);
    ...
    private void drawAlphaPanel(Canvas canvas) {
        ...
        if(mAlphaSliderText != null && !mAlphaSliderText.equals("")){
            canvas.drawText(mAlphaSliderText, rect.centerX(),
                    rect.centerY() + Tools.dpToPx(getContext(), 4),
                    mAlphaTextPaint);
        }
    ...
    private int getPreferredWidth(){
        ...
        int width = Tools.dpToPx(getContext(), 200);

        return (int) (width + mHuePanelWidthPx + mPanelSpacingPx);
    }

    private int getPreferredHeight(){
        int height = Tools.dpToPx(getContext(), 200);
    ...
    private void setUpAlphaRect(){
        ...
        mAlphaPattern = new AlphaPatternDrawable(Tools.dpToPx(getContext(), 5));
