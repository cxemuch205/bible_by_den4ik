...
public class ContentManager {
    ...
    @Inject
    public ContentManager(Activity activity, BibleDB bibleDB, UserDB userDB) {
    ...
    public void getListBooks(final String tag, final OnGetContentListener adapterProgress) {
    ...
    public void getListChapters(final String tag, final OnGetContentListener adapterProgress) {
        adapterProgress.onStartGet();
        new Thread(new Runnable() {
            @Override
            public void run() {
    ...
    public void getListPoemsFromChapter(final int chapter, final String tag, final OnGetContentListener adapterProgress) {
        adapterProgress.onStartGet();
        new Thread(new Runnable() {
            @Override
            public void run() {
    ...
    public void executeSearch(final String textQuery,
                                     final String tag,
    ...
    public ArrayList<BookMark> convertPoemToBookmarkArray(ArrayList<Poem> poems) {
        ...
        for (Poem poem : poems) {
            ...
            bookMark.setTableName(Tools.getTranslateWitchPreferences(activity));
    ...
    public void getBookmarks(final String tag, final OnGetContentListener contentListener) {
    ...
    public void getHistory(final String tag, final OnGetContentListener getBookmarksAdapter) {
    ...
    public String convertForClipboard(ArrayList<Poem> poems) {
        ...
        if (poems != null && poems.size() > 0) {
            for (int i = 0; i < poems.size(); i++) {
                ...
                if (poems.size() == 1) {
                    ...
                    result.append(Tools.getBookNameByBookId(poem.bookId, activity))
                            .append(" ")
                            .append(poem.chapter)
                            .append(":")
                            .append(poem.poem)
    ...
    public String parseListPoems(ArrayList<Poem> poems) {
    ...
    public ArrayList<Poem> sortByTranslate(ArrayList<Poem> poems) {
        ArrayList<Poem> result = new ArrayList<Poem>();
