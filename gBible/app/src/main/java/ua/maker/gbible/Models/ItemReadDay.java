...
public class ItemReadDay {
	...
	private ArrayList<Poem> listPoemOld = null;
	private ArrayList<Poem> listPoemNew = null;
	...
	public ArrayList<Poem> getListPoemNew() {
		return listPoemNew;
	}
	
	public ArrayList<Poem> getListPoemOld() {
		return listPoemOld;
	}
	...
	public void setListPoemNew(ArrayList<Poem> listPoemNew) {
		this.listPoemNew = listPoemNew;
	}
	
	public void setListPoemOld(ArrayList<Poem> listPoemOld) {
